...
type SubscriberGxInterface struct {
	...
	GxReportingAVP1           []any  `json:"gxreportingavp1,omitempty"`
	...
	GxReportingAVP2           []any  `json:"gxreportingavp2,omitempty"`
	...
	GxReportingAVP3           []any  `json:"gxreportingavp3,omitempty"`
	...
	GxReportingAVP4           []any  `json:"gxreportingavp4,omitempty"`
	...
	GxReportingAVP5           []any  `json:"gxreportingavp5,omitempty"`
	...
	ServicePathAVP            []any  `json:"servicepathavp,omitempty"`
...
type SubscriberParam struct {
	...
	IPv6PrefixLookupList []any    `json:"ipv6prefixlookuplist,omitempty"`
